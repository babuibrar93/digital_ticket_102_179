                ...
                >
                    <View style={{ flexDirection: 'row' }}>
                        ...
                        <View style={{ marginHorizontal: SIZES.radius, justifyContent: 'space-around' }}>
                            <Text style={{ ...FONTS.h3 }}>Siachen Glacier</Text>
                            <Text style={{ color: COLORS.gray, ...FONTS.body3 }}>Islamabad</Text>
                    ...
                    <View style={{ marginTop: SIZES.radius }}>
                        ...
                        Siachen Glacier offers simple rooms with mountain views in front of the ski lift to the Ski Resort
                        </Text>
                    </View>
                </View>
